...
from src.services.analysis_run_service import (
    ...
    upload_analysis_artifacts as upload_analysis_artifacts_service,
)
...
async def upload_analysis_artifacts(
    ...
    return await upload_analysis_artifacts_service(type, repository, branch, range, projectName, options, files, user)
